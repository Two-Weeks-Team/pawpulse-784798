...
<div class="max-w-3xl mx-auto px-4 py-12 sm:py-16">
  ...
  <section class="bg-[#171717] border border-[#262626] rounded-xl p-6 mb-4">
    ...
    <form id="symptomForm" onsubmit="return handleSymptomCheck(event)" class="space-y-4">
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label class="block text-sm font-medium text-neutral-300 mb-1" for="sc-pet-id">Pet ID</label>
          <input id="sc-pet-id" type="number" min="1" value="1" required class="w-full bg-[#0a0a0a] border border-[#262626] rounded-lg px-3 py-2 text-sm text-neutral-200 focus:outline-none focus:border-[#ec4899] focus:ring-1 focus:ring-[#ec4899]/50 transition" />
        </div>
        <div>
  ...
  <section class="bg-[#171717] border border-[#262626] rounded-xl p-6 mb-4">
    ...
    <form id="reportForm" onsubmit="return handleReport(event)" class="space-y-4">
      <div>
        <label class="block text-sm font-medium text-neutral-300 mb-1" for="rp-pet-id">Pet ID</label>
        <input id="rp-pet-id" type="number" min="1" value="1" required class="w-full sm:w-48 bg-[#0a0a0a] border border-[#262626] rounded-lg px-3 py-2 text-sm text-neutral-200 focus:outline-none focus:border-[#8b5cf6] focus:ring-1 focus:ring-[#8b5cf6]/50 transition" />
      </div>
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
  ...
  <div class="flex gap-3 justify-center flex-wrap mb-8">
    <a href="/docs" class="px-5 py-2 bg-[#ec4899] text-white font-semibold rounded-lg text-sm hover:bg-[#db2777] transition">API Docs</a>
    <a href="/redoc" class="px-5 py-2 bg-[#262626] text-neutral-300 border border-[#404040] font-semibold rounded-lg text-sm hover:bg-[#333] transition">ReDoc</a>
    <a href="/openapi.json" class="px-5 py-2 bg-[#262626] text-neutral-300 border border-[#404040] font-semibold rounded-lg text-sm hover:bg-[#333] transition">OpenAPI Spec</a>
  </div>
